  ...
  #app
    ...
    #button
      a(href="/about")
        button#about(
          :style="HoverAbout"
          @mouseover=" hovered.about = true"
          @mouseleave="hovered.about = false"
        ) about

      a(href="/support")
        button#support(
          :style="HoverSupport"
          @mouseover=" hovered.support = true"

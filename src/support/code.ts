...
on_([ 
  ...
  ['#about, #about button', 'mouseover', () => {
    mode > 0 ? css_('#about button', { color: '#eee', background: '#222' })
             : css_('#about button', { color: '#222', background: '#eee' })
  }],
  
  ['#about, #about button', 'mouseout', () => {
    css_('body', 'background-color', 0, 'GET') === 'rgb(255, 255, 255)' ? mode = 0 : mode = 1
  
    mode > 0 ? css_('#about button', { color: '#222', background: '#eee' })
             : css_('#about button', { color: '#eee', background: '#222' })
  }]
])
